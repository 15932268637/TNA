        ...
        <div id="login">
            <div class="main_body">
                ...
                <div class="right">
                    ...
                    <s:actionerror />
                    <form action="${pageContext.request.contextPath}/admin/adminLoginAction" method="post" name="myform">
                    	<table>
                    		<tr>
                        		<td>用 户 名：</td>
                        	...
                        	<tr>
                        		<td colspan="3">
		                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                            <input type="button" name="" value="确&nbsp;&nbsp;认" onclick="loginSubmit()" />
		                            <input type="button" name="" value="取&nbsp;&nbsp;消" />
		                            <!-- <input type="button" name="" value="注&nbsp;&nbsp;册" onclick="window.location.href='registration.jsp'"/> -->
                                </td>
                            </tr>
                        </table>
                    </form>
